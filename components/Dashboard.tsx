/**
 * Dashboard - Complete with Yoda Style + Footer + Immagine Shutterstock
 */
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="w-20 h-20 shrink-0 bg-slate-800 rounded-full border-2 border-teal-500/50 flex items-center justify-center shadow-[0_0_20px_rgba(45,212,191,0.3)] overflow-hidden relative group">
