...
export default function Home() {
  ...
  function determineRecommendation(result: any): 'YES_PAID' | 'NO_PAID' | 'TEST' {
    ...
    if (advertiserCount > 8 && cpc > 1.5 && competition > 0.7) return 'YES_PAID';
    if (advertiserCount < 3 && cpc < 0.5 && competition < 0.3) return 'NO_PAID';
    if (volume > 5000 && competition > 0.5 && advertiserCount > 5) return 'YES_PAID';
    return 'TEST';
  }
          ...
          <div className="p-8 space-y-10">
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-bold text-amber-400 uppercase tracking-widest mb-1">
                    🔑 Chiave del Cristallo Kyber (Gemini AI)
                  </h3>
                  <p className="text-xs text-slate-400 leading-relaxed mb-3">
                    La tua <strong className="text-amber-300">API Key di Google Gemini</strong> è necessaria per alimentare la Forza.{' '}
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500 text-right">
                {keywordCount} / 150 keywords (il resto verrà troncato)
              </p>
            </div>
